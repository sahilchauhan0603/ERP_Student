...
const navItems = [
  ...
  { label: 'All Students', path: '/admin/students', icon: 'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z' },
  { label: 'Pending Students', path: '/admin/students/pending', icon: 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z' },
  { label: 'Approved Students', path: '/admin/students/approved', icon: 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z' },
  { label: 'Declined Students', path: '/admin/students/declined', icon: 'M6 18L18 6M6 6l12 12' },
];
...
export default function AdminSidebar({ open, onClose }) {
  ...
  const sidebarClasses = `fixed h-screen bg-gradient-to-b from-blue-800 to-blue-600 text-white w-64 flex flex-col shadow-xl z-30 transition-transform duration-300
    ${open ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0 md:static md:z-10`;

  return (
    <>
      {/* Backdrop for mobile */}
      {open && (
        <div className="fixed inset-0 bg-black bg-opacity-40 z-20 md:hidden" onClick={onClose}></div>
      )}
