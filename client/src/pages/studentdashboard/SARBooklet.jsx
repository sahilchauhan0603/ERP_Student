...
export default function SARBooklet() {
  ...
  const handleSave = async (section) => {
    ...
    if (section === "personal" || section === "family") {
      ...
      toggleEdit(section);
      alert(`${section.charAt(0).toUpperCase() + section.slice(1)} details saved (locally)`);
    }
  };
  ...
  if (error) {
    return <div className="text-red-400 p-8 bg-white rounded shadow max-w-4xl mx-auto mt-8">{error}</div>;
  }
    ...
    <div className="pt-8 pb-12 bg-gradient-to-br from-gray-25 to-gray-50 min-h-screen">
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="flex overflow-x-auto justify-center mb-6 bg-white rounded-lg shadow-sm border border-gray-200 sticky top-2 z-10">
          {["personal", "family", "academic", "achievements", "internship"].map((section) => (
            <button
              key={section}
              onClick={() => {
        ...
        <section id="personal" className="mb-8 bg-white rounded-lg shadow-sm p-6 border border-gray-100">
          ...
          {editMode.personal ? (
            ...
            >
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => updateField("personal", "middleName", e.target.value)}
                  className="w-full border border-gray-300 rounded-md px-4 py-2.5 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition"
                />
              </div>
              <div>
              ...
              <div className="md:col-span-2">
                <label className="block mb-2 text-sm font-medium text-gray-700">Permanent Address</label>
                <textarea
                  value={form.personal.permanentAddress}
                  onChange={(e) => updateField("personal", "permanentAddress", e.target.value)}
                  className="w-full border border-gray-300 rounded-md px-4 py-2.5 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition"
                  rows={3}
                />
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 text-gray-700">
              <div className="py-2.5 border-b border-gray-200">
                <div className="text-xs font-medium text-gray-500 uppercase tracking-wider mb-1">First Name</div>
                <div className="font-medium">{form.personal.firstName || "N/A"}</div>
              </div>
              <div className="py-2.5 border-b border-gray-200">
                <div className="text-xs font-medium text-gray-500 uppercase tracking-wider mb-1">Middle Name</div>
                <div className="font-medium">{form.personal.middleName || "N/A"}</div>
              </div>
              <div className="py-2.5 border-b border-gray-200">
                <div className="text-xs font-medium text-gray-500 uppercase tracking-wider mb-1">Last Name</div>
                <div className="font-medium">{form.personal.lastName || "N/A"}</div>
              </div>
              <div className="py-2.5 border-b border-gray-200">
                <div className="text-xs font-medium text-gray-500 uppercase tracking-wider mb-1">Date of Birth</div>
                <div className="font-medium">{form.personal.dob || "N/A"}</div>
              </div>
              <div className="py-2.5 border-b border-gray-200">
                <div className="text-xs font-medium text-gray-500 uppercase tracking-wider mb-1">Gender</div>
                <div className="font-medium">{form.personal.gender || "N/A"}</div>
              </div>
              <div className="py-2.5 border-b border-gray-200">
                <div className="text-xs font-medium text-gray-500 uppercase tracking-wider mb-1">Email</div>
                <div className="font-medium">{form.personal.email || "N/A"}</div>
              </div>
              <div className="py-2.5 border-b border-gray-200">
                <div className="text-xs font-medium text-gray-500 uppercase tracking-wider mb-1">Mobile</div>
                <div className="font-medium">{form.personal.mobile || "N/A"}</div>
              </div>
              <div className="md:col-span-2 py-2.5 border-b border-gray-200">
                <div className="text-xs font-medium text-gray-500 uppercase tracking-wider mb-1">Current Address</div>
                <div className="font-medium">{form.personal.currentAddress || "N/A"}</div>
              </div>
              <div className="md:col-span-2 py-2.5">
                <div className="text-xs font-medium text-gray-500 uppercase tracking-wider mb-1">Permanent Address</div>
                <div className="font-medium">{form.personal.permanentAddress || "N/A"}</div>
              </div>
            </div>
          )}
        </section>
        ...
        <section id="family" className="mb-8 bg-white rounded-lg shadow-sm p-6 border border-gray-100">
          <div className="flex justify-between items-center mb-5 pb-2 border-b border-gray-100">
          ...
          {editMode.family ? (
            ...
            >
              <div>
                <label className="block mb-2 text-sm font-medium text-gray-700">Father's Name</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block mb-2 text-sm font-medium text-gray-700">Family Income</label>
                <input
                  type="text"
                  value={form.family.familyIncome}
                  onChange={(e) => updateField("family", "familyIncome", e.target.value)}
                  className="w-full border border-gray-300 rounded-md px-4 py-2.5 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition"
                />
              </div>
              <div>
                <label className="block mb-2 text-sm font-medium text-gray-700">Father's Mobile</label>
                <input
                  type="text"
                  value={form.family.fatherMobile}
                  onChange={(e) => updateField("family", "fatherMobile", e.target.value)}
                  className="w-full border border-gray-300 rounded-md px-4 py-2.5 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition"
                />
              </div>
              <div>
                <label className="block mb-2 text-sm font-medium text-gray-700">Mother's Mobile</label>
                <input
                  type="text"
                  value={form.family.motherMobile}
                  onChange={(e) => updateField("family", "motherMobile", e.target.value)}
                  className="w-full border border-gray-300 rounded-md px-4 py-2.5 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition"
                />
              </div>
              <div className="md:col-span-2 flex justify-end pt-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 text-gray-700">
              <div className="py-2.5 border-b border-gray-200">
                <div className="text-xs font-medium text-gray-500 uppercase tracking-wider mb-1">Father's Name</div>
                <div className="font-medium">{form.family.fatherName || "N/A"}</div>
              </div>
              <div className="py-2.5 border-b border-gray-200">
                <div className="text-xs font-medium text-gray-500 uppercase tracking-wider mb-1">Mother's Name</div>
                <div className="font-medium">{form.family.motherName || "N/A"}</div>
              </div>
              <div className="py-2.5 border-b border-gray-200">
                <div className="text-xs font-medium text-gray-500 uppercase tracking-wider mb-1">Family Income</div>
                <div className="font-medium">{form.family.familyIncome || "N/A"}</div>
              </div>
              <div className="py-2.5 border-b border-gray-200">
                <div className="text-xs font-medium text-gray-500 uppercase tracking-wider mb-1">Father's Mobile</div>
                <div className="font-medium">{form.family.fatherMobile || "N/A"}</div>
              </div>
              <div className="py-2.5">
                <div className="text-xs font-medium text-gray-500 uppercase tracking-wider mb-1">Mother's Mobile</div>
                <div className="font-medium">{form.family.motherMobile || "N/A"}</div>
              </div>
            </div>
          )}
        </section>
        ...
        <section id="academic" className="mb-8 bg-white rounded-lg shadow-sm p-6 border border-gray-100">
          <div className="flex justify-between items-center mb-5 pb-2 border-b border-gray-100">
          ...
          {editMode.academic ? (
            ...
            >
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => updateField("academic", "rollNumber", e.target.value)}
                  className="w-full border border-gray-300 rounded-md px-4 py-2.5 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition"
                />
              </div>
              <div>
              ...
              <div>
                <label className="block mb-2 text-sm font-medium text-gray-700">CGPA</label>
                <input
                  type="text"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 text-gray-700">
              <div className="py-2.5 border-b border-gray-200">
                <div className="text-xs font-medium text-gray-500 uppercase tracking-wider mb-1">Course</div>
                <div className="font-medium">{form.academic.course || "N/A"}</div>
              </div>
              <div className="py-2.5 border-b border-gray-200">
                <div className="text-xs font-medium text-gray-500 uppercase tracking-wider mb-1">Roll Number</div>
                <div className="font-medium">{form.academic.rollNumber || "N/A"}</div>
              </div>
              <div className="py-2.5 border-b border-gray-200">
                <div className="text-xs font-medium text-gray-500 uppercase tracking-wider mb-1">Semester</div>
                <div className="font-medium">{form.academic.semester || "N/A"}</div>
              </div>
              <div className="py-2.5">
                <div className="text-xs font-medium text-gray-500 uppercase tracking-wider mb-1">CGPA</div>
                <div className="font-medium">{form.academic.cgpa || "N/A"}</div>
              </div>
            </div>
          )}
        </section>
        ...
        <section id="achievements" className="mb-8 bg-white rounded-lg shadow-sm p-6 border border-gray-100">
          <div className="flex justify-between items-center mb-5 pb-2 border-b border-gray-100">
          ...
          {editMode.achievements ? (
            ...
            >
              <label className="block mb-2 text-sm font-medium text-gray-700">Achievements / Activities</label>
              <textarea
                rows={5}
                value={form.achievements.achievementsText}
                onChange={(e) =>
                  updateField("achievements", "achievementsText", e.target.value)
                }
                className="w-full border border-gray-300 rounded-md px-4 py-2.5 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition"
            ...
            <div>
              <div className="text-xs font-medium text-gray-500 uppercase tracking-wider mb-2">Achievements / Activities</div>
              <p className="whitespace-pre-wrap text-gray-700 bg-gray-50 p-4 rounded-md min-h-[100px]">
                {form.achievements.achievementsText || "No achievements recorded."}
              </p>
            </div>
          )}
        </section>
        ...
        <section id="internship" className="mb-8 bg-white rounded-lg shadow-sm p-6 border border-gray-100">
          <div className="flex justify-between items-center mb-5 pb-2 border-b border-gray-100">
            <h2 className="text-xl font-semibold text-gray-800">Internship Details</h2>
            <button
          ...
          {editMode.internship ? (
            ...
            >
              <div>
                ...
                <input
                  ...
                  onChange={(e) => updateField("internship", "companyName", e.target.value)}
                  className="w-full border border-gray-300 rounded-md px-4 py-2.5 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition"
                />
              </div>
              <div>
                ...
                <input
                  ...
                  onChange={(e) => updateField("internship", "position", e.target.value)}
                  className="w-full border border-gray-300 rounded-md px-4 py-2.5 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition"
                />
              </div>
              <div>
                ...
                <input
                  ...
                  onChange={(e) => updateField("internship", "duration", e.target.value)}
                  className="w-full border border-gray-300 rounded-md px-4 py-2.5 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition"
              ...
              <div className="md:col-span-2">
                ...
                <textarea
                  ...
                  onChange={(e) => updateField("internship", "description", e.target.value)}
                  className="w-full border border-gray-300 rounded-md px-4 py-2.5 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 text-gray-700">
              <div className="py-2.5 border-b border-gray-200">
                <div className="text-xs font-medium text-gray-500 uppercase tracking-wider mb-1">Company Name</div>
                <div className="font-medium">{form.internship.companyName || "N/A"}</div>
              </div>
              <div className="py-2.5 border-b border-gray-200">
                <div className="text-xs font-medium text-gray-500 uppercase tracking-wider mb-1">Position</div>
                <div className="font-medium">{form.internship.position || "N/A"}</div>
              </div>
              <div className="py-2.5 border-b border-gray-200">
                <div className="text-xs font-medium text-gray-500 uppercase tracking-wider mb-1">Duration</div>
                <div className="font-medium">{form.internship.duration || "N/A"}</div>
              </div>
              <div className="md:col-span-2 py-2.5">
                <div className="text-xs font-medium text-gray-500 uppercase tracking-wider mb-1">Description</div>
                <div className="font-medium whitespace-pre-wrap">{form.internship.description || "N/A"}</div>
              </div>
            </div>
          )}
        </section>
