  ...
  return (
    <div className="max-w-4xl mx-auto bg-white p-6 sm:p-10 rounded-3xl shadow-2xl border border-gray-200 animate-fade-in">
        ...
        <div className="prose max-w-none">
          ...
          <ol className="space-y-6 list-decimal pl-5 marker:text-gray-500 marker:font-bold">
            <li className="pl-2">
              ...
              and fill the form to get your reference number. You will need this
              number later in the registration form.
            </li>
            ...
            <li className="pl-2">
              <div className="bg-blue-50/50 p-4 rounded-lg border border-blue-100">
                <p className="font-medium text-blue-700/90 mb-2">
            ...
            <li className="pl-2">
              <div className="bg-blue-50/50 p-4 rounded-lg border border-blue-100">
                <p className="font-medium text-amber-700/90">
                  ...
                  Important: Ensure all information matches your official
                  documents. Any discrepancies may lead to cancellation of
                  admission.
                </p>
              </div>
            </li>
      ...
      <div className="flex items-center bg-blue-50/50 p-4 rounded-lg border border-blue-100 0 mb-10">
        ...
        <label
          htmlFor="agree-terms"
          className="ml-3 text-blue-800/90 font-semibold"
        >
