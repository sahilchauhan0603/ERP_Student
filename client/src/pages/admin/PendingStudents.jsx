...
import { FiUser, FiMail, FiClock, FiEye, FiRefreshCw } from 'react-icons/fi';
        ...
        {loading ? (
          ...
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-medium text-gray-900">
              {searchTerm ? 'No matching students found' : 'No pending applications'}
            </h3>
            <p className="mt-1 text-gray-500">
              {searchTerm ? 'Try a different search term' : 'All applications have been processed'}
            </p>
            {searchTerm && (
              <button
