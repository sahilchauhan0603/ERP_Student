...
import { FiUser, FiMail, FiX, FiEye, FiRefreshCw, FiSearch } from 'react-icons/fi';
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              ...
              <p className="text-gray-600 mt-1">
                {students.length} application{students.length !== 1 ? 's' : ''} declined
              </p>
            </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-medium text-gray-900">
              {searchTerm ? 'No matching students found' : 'No declined applications'}
            </h3>
            <p className="mt-1 text-gray-500">
              {searchTerm ? 'Try a different search term' : 'No applications have been declined yet'}
            </p>
            {searchTerm && (
              <button
