                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-3">
                      <p className="text-green-800 text-sm font-medium">
                        Please use your registered student email address. Check spam folder if OTP doesn't arrive.
                      </p>
                    </div>
                  </div>
                </div>
                        ...
                        {otpDigits.map((digit, idx) => (
                          <input
                            ...
                            className={`w-12 h-14 text-center text-2xl font-black border-2 rounded-xl shadow-sm focus:ring-4 focus:ring-green-500/20 focus:border-green-500 transition-all duration-200 ${
                              digit ? "border-green-500 bg-green-50 text-green-600" : "border-gray-300 bg-white text-gray-900"
                            }`}
                            value={digit}
