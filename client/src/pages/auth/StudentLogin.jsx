...
const StudentLogin = () => {
  ...
  const handleSendOtp = async (e) => {
    ...
    setLoading(true);
    try {
      await axios.post(`${import.meta.env.VITE_API_URL}/student/send-login-otp`, { email });
      setStep(2);
  ...
  const handleVerifyOtp = async (e) => {
    ...
    setLoading(true);
    try {
      await axios.post(`${import.meta.env.VITE_API_URL}/student/verify-login-otp`, { email, otp });
            ...
            <form className="space-y-6" onSubmit={handleVerifyOtp}>
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className={`ml-3 inline-flex justify-center py-2 px-6 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 ${(loading || otp.length !== 6) ? 'opacity-75 cursor-not-allowed' : ''}`}
                >
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white text-gray-500">
                  New student?{' '}
                  <a href="/registration/student" className="font-medium text-blue-600 hover:text-blue-500">
                    Create account
                  </a>
                </span>
              </div>
